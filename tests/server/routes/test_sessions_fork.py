...
async def test_fork_of_switched_session_roots_the_clone_name() -> None:
    """Forks of switch clones must use the root agent name."""
...
async def test_fork_preserves_user_authored_suffix_looking_name(
    ...
    """Keep user-authored suffixes unless they match an exact generated ID shape.

    Four-character hex words and non-hex names are not framework clone IDs."""
    user_named = Agent(
