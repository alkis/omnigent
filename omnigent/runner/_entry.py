...
async def _run_mint_keepalive(
    ...
    *,
    ...
    """Refresh managed credentials while idle, before the current proxy bearer expires.

    :param keepalive: Factory hook; reads the cache outside the refresh window.
    :param interval_s: Cadence in seconds, below _MANAGED_MINT_REFRESH_SKEW_S.
